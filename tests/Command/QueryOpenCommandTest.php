...
#[CoversClass(QueryOpenCommand::class)]
final class QueryOpenCommandTest extends AbstractCommandTestCase
{
    ...
    {
        $command = self::getService(QueryOpenCommand::class);
    ...
    public function testCommandInstance(): void
    {
        ...
        $this->assertInstanceOf(QueryOpenCommand::class, $command);
    }
